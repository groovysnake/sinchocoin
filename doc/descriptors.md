# Support for Output Descriptors in Sinchocoin Core

Since Sinchocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Sinchocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Sinchocoin Core wallets, a convenience function `combo` is
