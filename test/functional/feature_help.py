...
"""Verify that starting sinchocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sinchocoin with -h for help text")
        ...
        self.log.info("Start sinchocoin with -version for version information")
        ...
        self.log.info("Start sinchocoind with -fakearg to make sure it does not start")
