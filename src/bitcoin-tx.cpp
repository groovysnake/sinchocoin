...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sinchocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sinchocoin-tx [options] <hex-tx> [commands]  Update hex-encoded sinchocoin transaction\n" +
            "or:     sinchocoin-tx [options] -create [commands]   Create hex-encoded sinchocoin transaction\n" +
            "\n";
